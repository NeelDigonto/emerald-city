    ...
    if (mode === "translate") {
      ...
      if (this.scaleSnap) {
        if (this.uniformScale) {
          let scale;
          if (axis.search("X") !== -1) scale = object.scale.x;
          if (axis.search("Y") !== -1) scale = object.scale.y;
          if (axis.search("Z") !== -1) scale = object.scale.z;

          scale =
            Math.round(scale / this.scaleSnap) * this.scaleSnap ||
            this.scaleSnap;
